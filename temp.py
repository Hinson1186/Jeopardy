...
# ==========================================
ASSET_FILES = {
    # BACKGROUNDS (Will be scaled to 1280x720)
...
class UIManager:
    ...
    def load_all_assets(self):
        ...
        # List of the keys that are backgrounds. The rest are treated as icons.
        background_keys = [
    ...
    def draw_board_screen(self, game_manager):
        # Using your 'stage' image for the main board background
    ...
    def draw_clue_screen(self, clue):
        # Using your 'background' image for questions
    ...
    def draw_loading_screen(self):
        # Using 'LED_blue' screen for loading
    ...
    def draw_menu(self):
        # Using 'LED_red' for the main menu
